...
public class TypesSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case TypesPackage.DECLARATION_TYPE_REFERENCE:
      {
      ...
      case TypesPackage.COMPLEX_TYPE:
      {
        ...
        if (result == null) result = caseNamedType(complexType);
      ...
      case TypesPackage.ENTITY_TYPE:
      {
        ...
        if (result == null) result = caseComplexType(entityType);
      ...
      {
        MappedByReference mappedByReference = (MappedByReference)theEObject;
        T result = caseMappedByReference(mappedByReference);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TypesPackage.LITERAL:
      {
      ...
      case TypesPackage.PROPERTY_REFERENCE:
      {
        ...
        if (result == null) result = caseLiteral(propertyReference);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Mapped By Reference</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Mapped By Reference</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMappedByReference(MappedByReference object)
  {
    return null;
  }
